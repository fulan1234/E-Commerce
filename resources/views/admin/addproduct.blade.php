              ...
              <form action="{{route('storeproduct')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select class="form-select" id="product_category_id" aria-label="Default select example" name="product_category_id">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select class="form-select" id="product_subcategory_id" aria-label="Default select example" name="product_subcategory_id">
